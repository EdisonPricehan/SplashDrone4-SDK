// fly_state_report.h: Definition of fly state report.
...
#ifndef SPLASHDRONE4_ROS_FLY_STATE_REPORT_H
#define SPLASHDRONE4_ROS_FLY_STATE_REPORT_H
...
#endif //SPLASHDRONE4_ROS_FLY_STATE_REPORT_H